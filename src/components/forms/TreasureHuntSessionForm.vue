        ...
        <div class="q-pa-md q-ma-md">
            <q-card>
                <q-card-section class="bg-primary text-center text-white">
                    <div class="text-h6">Treasure Hunt</div>
                </q-card-section>
...
} from '../../enums/sessionEnums';


export default {
    name: 'TreasureHuntSessionForm',
    setup() {
        ...
        return {
            ...
            session: ref(null),
            characters: ref([]),
            filteredCharacterOptions: ref(null),
            filterValue: ref(''),
            id: ref(null),
            seller: ref(null),
            character: ref(null),
    ...
    async created() {
        ...
        this.filteredCharacterOptions = this.characters;
    ...
    computed: {
        ...
        selectedUnloadType: {
            ...
            set(option) {
                this.unloadType = option.value; // Assuming the option structure is { label: 'Label', value: 'Value' }
            }
        }
    },
    props: {
