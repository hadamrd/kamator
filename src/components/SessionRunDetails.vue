      ...
      <q-card-section>
        <div class="row q-gutter-md">
          <div class="col-6">
            ...
            <div>
              earnedLevels: ({{ sessionRun.earnedLevels }},
              {{ sessionRun.mapY }})
            </div>
            <div>nbrFightsDone: {{ sessionRun.nbrFightsDone }}</div>
            <div>
              nbrTreasuresHuntsDone: {{ sessionRun.nbrTreasuresHuntsDone }}
            </div>
          ...
          <div class="col-6">
            ...
            <div>
              kamasSpentTeleporting: {{ sessionRun.kamasSpentTeleporting }}
            </div>
            <div>numberOfTeleports: {{ sessionRun.numberOfTeleports }}</div>
            <div>
              kamasSpentOpeningBank: {{ sessionRun.kamasSpentOpeningBank }}
            </div>
          </div>
        </div>
      </q-card-section>
