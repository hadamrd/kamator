<template>
    <div>
        <q-card class="q-pa-md">
            <q-card-section>
                <q-btn color="negative" label="Clear All" icon="delete" @click="clearAllNotifications"
                    class="q-mb-md" />
            </q-card-section>
            <q-card-section>
...
export default {
    ...
    setup() {
        ...
        const columns = [
            ...
            { name: 'character_name', label: 'Character', field: 'character_name', sortable: true },
            { name: 'earnedKamas', label: 'Kamas Earned', field: 'earnedKamas', sortable: true },
            { name: 'earnedLevels', label: 'Levels Earned', field: 'earnedLevels', sortable: true },
            { name: 'nbrFightsDone', label: 'Fights Done', field: 'nbrFightsDone', sortable: true },
