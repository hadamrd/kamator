<template>
            ...
            <q-btn label="New Session" color="primary" @click="toggleMenu">
                <q-menu v-model="menuOpen">
                    <q-list style="min-width: 100px;">
                        <q-item v-for="option in sessionStore.sessionTypesChoices" :key="option.value" clickable
    ...
    <component :is="currentFormComponent" v-model="showSessionForm" :key="selectedSessionType" @finished="resetForm" />
</template>
