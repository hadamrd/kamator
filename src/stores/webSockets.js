    ...
    actions: {
        ...
        handleMessage(event) {
            ...
            if (notifyData.type === this.status_notify_type) {
                this.sessionRunStore.updateSessionStatus(notifyData.session_run_id, notifyData.new_status, notifyData.details);
                ...
                this.sessionRunStore.updateSessionStats(notifyData.session_run_id, notifyData.player_stats)
            } else {
